...
<section className="relative flex flex-col ">
  <div className="absolute inset-0 -top-16 -z-10 lg:-top-28">
    <div  >
      <div className="absolute inset-x-0 top-14 md:top-56 max-w-[1280px] overflow-hidden lg:bottom-auto lg:left-auto lg:right-0 lg:w-[80%]">
      <OrbitingCirclesDemo />
  ...
  <div className="mb-12 mt-64 border-white/[.03] md:mt-28 lg:my-40 lg:border-y lg:py-2">
    <div className="mx-auto w-full max-w-7xl px-4 md:px-6">
      ...
      <div className="mt-8 max-w-lg space-y-6 text-lg leading-[1.4] text-gray-300 md:max-w-xl lg:text-xl">
        <p>Ingeniero Informático enfocado en el desarrollo de software Full Stack, utilizando tecnologías como Node.js (Express), Java (Spring), PostgreSQL y MySQL para el backend y React con Tailwind para el frontend.</p>
