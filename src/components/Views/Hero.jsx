...
<div className="absolute h-28 w-28 bg-pastel-cyan rounded-full top-0 -left-16"></div>
    ...
    <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <p className="max-w-[35rem] mb-6 font-light text-arsenic lg:mb-8 md:text-lg lg:text-xl "><strong>Ingeniero Informático </strong>con conocimientos en <strong>Desarrollo Web Full Stack y Análisis de Sistemas</strong>.</p>
