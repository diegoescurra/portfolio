...
const CardCertificate = ({props}) => {
  return (
    <article className='shadow-sm rounded-sm'>
        ...
        <div className="flex justify-between text-gray-500 text-sm border-b-2 border-gray-50 py-2 mb-3">
            <span>{props.issuer}</span>
            <span>{props.year}</span>
        </div>
        <h4 className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Skills Adquiridas</h4>
